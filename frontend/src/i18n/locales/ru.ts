const ru = {
  ...
  navigation: {
    ...
    staffReferences: 'Кадровые справочники',
  },
  ...
  modules: {
    ...
    preparedDescription: 'Маршрут, layout и базовые компоненты подключены. CRUD-интерфейс будет реализован на соответствующем этапе.',
    demoMode: 'Демонстрационный режим',
    createLater: 'Форма создания будет добавлена на этапе реализации CRUD.',
    returnHome: 'Вернуться на главную',
    departmentsDescription: 'Управление кафедрами и организационной структурой.',
    teachersDescription: 'Справочник преподавателей, ставок, степеней и учёных званий.',
    studentsDescription: 'Управление академическими группами и контингентом.',
    disciplinesDescription: 'Справочник учебных дисциплин.',
    curriculaDescription: 'Формирование и сопровождение учебных планов образовательных программ.',
    workloadDescription: 'Расчёт и распределение учебной нагрузки между преподавателями.',
    schedulesDescription: 'Планирование и просмотр расписания занятий.',
    reportsDescription: 'Формирование аналитических отчётов, PDF и Excel.',
    settingsDescription: 'Пользователи, роли, права доступа и параметры системы.',
    organizationDescription: 'Управление ВУЗами, факультетами и кафедрами',
  },
  ...
  staffReferences: {
    ...
    description:
      'Должности, учёные степени и учёные звания.',
    ...
    positions: {
      ...
      archiveConfirm:
        'Архивировать должность «{name}»?',
    },

    degrees: {
      create:
        'Добавить учёную степень',

      createTitle:
        'Создание учёной степени',

      editTitle:
        'Редактирование учёной степени',

      archiveTitle:
        'Архивирование учёной степени',

      archiveConfirm:
        'Архивировать учёную степень «{name}»?',
    },

    titles: {
      create:
        'Добавить учёное звание',

      createTitle:
        'Создание учёного звания',

      editTitle:
        'Редактирование учёного звания',

      archiveTitle:
        'Архивирование учёного звания',

      archiveConfirm:
        'Архивировать учёное звание «{name}»?',
    },
  },
